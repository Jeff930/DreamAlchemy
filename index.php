...
<html>
      ...
      <body>
         ...
         <div class="row">
               <div class="col-sm-12 col-md-12 col-lg-12 center-block">
                  <h4 id="heading" class="center-block">
                   Discover Your Astrological Dream Sign<br>
         ...
         <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 center-block">
               <h5 id="heading-text" class="center-block"><span class="capital"> uncovers an ancient secret technique that is within your astrological dream sign so
               <br> that you can unlock your dream manifestation abilities... <br></span>
               <br>
                  <b>Get Your FREE Astrological Dream Reading Now!</b>
               </h5>
            </div>
         </div>
         <div class="row">
         ...
         <br>
         <form method="post" action="./soulreading.php" id="soulreading-form">
            <div class="row mb-3">
               ...
               <div class="col-sm-12 col-md-6 col-lg-6 center-block">
                  <div class="astrology-description" data-id="aries">
                     <div class="row">
                        ...
                        <div class="col-6 col-sm-12 pr-5">
                           <div class="image-container">
         ...
         <div class=submit-form>
            ...
            <div class="row">
               <div class="col-sm-6 col-md-6 col-lg-6 form-group center-block">
                  <button class="custom-btn btn-25" name="Submit"><p>Get Your Free Astrological Dream Reading</p></button>
               </div>
            </div>
         </div>   
            <br>
            <div class="row">
               <div class="col-sm-6 col-md-6 col-lg-6 center-block">
                  <ul class="list-group">
                     <li class="list-group-item" style="background: transparent;color:white;font-family: Montserrat"><span class="pull-left "><img src="./assets/images/flower.jpg" style="width: 30px" class="img-reponsive img-rounded" /></span> -Where your destiny is headed and how you can change it. 
                     </li>
                     <li class="list-group-item" style="background: transparent;color:white;font-family: Montserrat"><span class="pull-left "><img src="./assets/images/flower.jpg" style="width: 30px" class="img-reponsive img-rounded" /></span> -The unique power your astrological sign gives you when using the law of attraction
                     </li>
                     <li class="list-group-item" style="background: transparent;color:white;font-family: Montserrat"><span class="pull-left "><img src="./assets/images/flower.jpg" style="width: 30px" class="img-reponsive img-rounded" /></span> -Discover the ancient secrets behind dreaming, and what this has to do with you now
                     </li>
                     <li class="list-group-item" style="background: transparent;color:white;font-family: Montserrat"><span class="pull-left "><img src="./assets/images/flower.jpg" style="width: 30px" class="img-reponsive img-rounded" /></span> -Uncover a technique that is now being used in hidden masterminds
                                          </li>
                     <li class="list-group-item" style="background: transparent;color:white;font-family: Montserrat"><span class="pull-left "><img src="./assets/images/flower.jpg" style="width: 30px" class="img-reponsive img-rounded" /></span> -And the modern powerful technique to accelerate your manifestation ability
                     </li>
                  </ul>
               </div>
            </div>
