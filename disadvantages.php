		...
		<div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 center-block">
							...
							<div class="col-sm-12 col-md-12 col-lg-6">
								<h6 style="text-align: justify;font-family: Open Sans;color:white;padding-left: 30px;padding-right: 30px;font-size: 22px">The Disadvantages
								</h6>
								<br>
								...
								<br>
								<h6 style="text-align: justify;font-family: Open Sans;color:white;padding-left: 30px;padding-right: 30px;font-size: 18px">You also have a tendency to be adaptive to the energy around you, which could ruin your manifestation process entirely.
								</h6>
								<br>
							</div>
              ...
              <a href="dreamsign.php"><button type="button" class="btn btn-primary btn-lg btn-block">Reveal Your Dream Sign</button></a>
							<br>
							</div>
						</div>
