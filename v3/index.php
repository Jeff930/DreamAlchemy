...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-sm-12 col-md-12 col-lg-12 center-block">
			<h4 id="heading" class="center-block">Your Soul Reading Reveals The Path That Your Soul Is On At This Point In Your Life</h4>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12 col-md-12 col-lg-12 center-block">
			<h5 id="heading-text" class="center-block">It Reveals The Challenges That May Be Blocking You On Your Soul’s Journey <br>
And The Opportunities Available To Help You At This Time in Your Life... <br>
<b>Get Your FREE Soul Reading Below…</b></h5>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12 col-md-12 col-lg-12">
			<a href="#form1" id="formButton"><img class="img-responsive center-block d-block" style="max-width:500px;" src="./assets/images/astrology.png"></a>
		</div>
	</div>
	<br>
	...
	<div class="row">
		<div class="col-sm-6 col-md-6 col-lg-6 center-block">
			<h2 style="color: white;text-align: center;font-family: Montserrat">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
	...
	<div class="row">
		<div class="col-sm-6 col-md-6 col-lg-6 center-block">
			<p style="color: white;text-align: center;font-family: Montserrat">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
	...
	<br>
		<div class="row">
			<div class="col-sm-6 col-md-6 col-lg-6 center-block">
				<h2 style="color: white;text-align: center;font-family: Montserrat;text-transform: uppercase;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
				tempor incididunt ut labore et dolore magna aliqua. </h2>
			</div>
		</div>
		<hr>
		<div class="row">
			<div class="col-sm-6 col-md-6 col-lg-6 center-block">
				<ul class="list-group">
	  	    <li class="list-group-item" style="background: transparent;color:white;font-family: Montserrat"><span class="pull-left "><img src="./assets/images/flower.jpg" style="width: 30px" class="img-reponsive img-rounded" /></span> Summary of sign
As a Taurus you are one of the most reliable signs in the zodiac. You make a good friend, a business partner, and a loyal romantic partner. </li>
	  	    <li class="list-group-item" style="background: transparent;color:white;font-family: Montserrat"><span class="pull-left "><img src="./assets/images/flower.jpg" style="width: 30px" class="img-reponsive img-rounded" /></span> Advantages to using sign in synchronicity with law of attraction
As a Taurus, your biggest advantage when it comes to manifesting your desires is persistence. </li>
	  	    <li class="list-group-item" style="background: transparent;color:white;font-family: Montserrat"><span class="pull-left "><img src="./assets/images/flower.jpg" style="width: 30px" class="img-reponsive img-rounded" /></span> The disadvantages you may face (manifestation blockages) 
