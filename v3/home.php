                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <video width="320" height="240" autoplay loop muted>
                                <source src="./assets/images/Zodiac2.mp4" type="video/mp4" class= "wow rollIn">
                            </video>
                        </div>
                        <div class="col-md-6">
                            <h2 class= "wow slideInRight" >Effective Prediction Techniques</h2>
                            <p class= "text-white wow slideInLeft">What future do the planets and the stars hold? Get the answers straight, be guided, and receive valuable insights from the best techniques in prediction. Unlock the dream you’ve been waiting for. 
                                          </p>
                            <div class="horoscope-btn d-flex">
                            <a href="http://staging.dreamalchemy.bestworkz.com/" class="def-btn">GET YOUR FREE READING</a>
                            </div>
                        </div>
                    </div>
                </div>
