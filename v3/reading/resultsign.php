					...
					<div class="col-sm-12 col-md-12 col-lg-12 center-block">
						...
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-6">
								<h6 style="text-align: justify;font-family: Open Sans;color:white;padding-left: 30px;padding-right: 30px;font-size: 15px">Now let’s talk about your sign and how you can start using your hidden gifts to manifest your desires…
								</h6>
								<br>

								<h6 style="text-align: justify;font-family: Open Sans;color:white;padding-left: 30px;padding-right: 30px;font-size: 27px"><strong>The Aquarius</strong>
								</h6>
								<br>
								...
								<br>
								<h6 style="text-align: justify;font-family: Open Sans;color:white;padding-left: 30px;padding-right: 30px;font-size: 18px">Now let’s get into what natural advantages you have when using the law of attraction.
								</h6>
								<br>
							</div>
							<div class="col-sm-12 col-md-12 col-lg-6 center-block">
								<img src="./assets/images/astro-signs/Aquarius.png" style="padding-left: 30px;padding-right:30px;" class="center-block">
							</div>
						</div>
						<div class="row" style="margin-top:60px">
							<div class="col-sm-12 col-md-12 col-lg-12 center-block">
								...
								<br>
								<h6 style="text-align: justify;font-family: Open Sans;color:white;padding-left: 30px;padding-right: 30px;font-size: 18px">And the force of planetary alignment is just asHere are some things that may be working against you if you are trying to harness the law of attraction to your liking…
								</h6>
							</div>
						</div>
						<br>
						<div class="row"  style="margin-top:60px">
							...
							<a href="disadvantages.php"><button type="button" class="btn btn-primary btn-lg btn-block" >Find Out Your Disadvantages</button></a>
							<br>
							</div>
						</div>
