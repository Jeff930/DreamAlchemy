...
<div class="container">
	<div class="row">
		<div class="col-sm-12 col-md-12 col-lg-12">
			<img class="img-responsive center-block d-block" style="max-width:20%;" src="./assets/images/logo.png">
		</div>
	</div>
	<br>
	<div class="box2">
	  <div class="col-sm-12 col-md-12 col-lg-12" style="background: white">
	  	...
	  	<p>Hi there, thank you so much for being here with me. Now there are many great laws in this universe such as the law of attraction, the law of rhythm , and the law of gestation just to name a few.
...
<ul class="list-group">
	  	    <li class="list-group-item"><span class="pull-left "><img src="./assets/images/flower.jpg" style="width: 30px" class="img-reponsive img-rounded" /></span> Summary of sign
...
Now let’s get into what natural advantages you have when using the law of attraction.</li>
	  	    <li class="list-group-item"><span class="pull-left "><img src="./assets/images/flower.jpg" style="width: 30px" class="img-reponsive img-rounded" /></span> Advantages to using sign in synchronicity with law of attraction
...
Here are some things that may be working against you if you are trying to harness the law of attraction to your liking…</li>
	  	    <li class="list-group-item"><span class="pull-left "><img src="./assets/images/flower.jpg" style="width: 30px" class="img-reponsive img-rounded" /></span> The disadvantages you may face (manifestation blockages) 
...
This powerful method has been used in civilizations such as ancient egypt, ancient india, has been shared among shamans many many years go. Click this link so I can reveal the same secrets that have been shared among many sacred circles.</p>
	  	<br>
	  	
	  	<a href="./finalresult.php" class="btn btn-primary btn-lg btn-block">CLICK HERE TO DISCOVER YOUR SOUL PATH</a>
	  	<br>
	  </div>
	</div>
	<br>
